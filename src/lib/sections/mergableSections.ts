...
const sectionAuthorityMap = new Map<ModelSection, string>([
    ...
    [SECTIONS_MAP.categoryCombo, 'F_CATEGORY_COMBO_MERGE'],
    [SECTIONS_MAP.categoryOptionCombo, 'F_CATEGORY_OPTION_COMBO_MERGE'],
    [SECTIONS_MAP.dataElement, 'F_DATA_ELEMENT_MERGE'],
    [SECTIONS_MAP.organisationUnit, 'F_ORGANISATION_UNIT_MERGE'],
])
